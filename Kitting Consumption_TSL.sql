SELECT
  ...
  "Warehouse Entry",
  "Ext Gross Weight",
  "DataSource=","Jet Data Warehouse 4.5",
  "Registering Date",L$280&".."&L$281,
  "Bin Code","PROD-*",
  "Entry Type","0",
  "Link=","Item","No","=Item No",
  "UNC Product Type Code",$H285,
  "UNC Storage Requirement Code",$G285,
  "FBC Product Type Code",$I285,
  "Inventory Posting Group",InvPostingGroup
  )